...
int state =1;
int s2i,s2f;
long duration1,duration2,cm1,cm2,gcm1,gcm2;
int a=0;


/*--------------------------Pin Connections-----------*/
#define TEMP_PIN 6        // Temp Sensor Pin
#define TRIG_PIN_1 10      // Trigger Pin of Ultrasonic Sensor 1
#define ECHO_PIN_1 9      // Echo Pin of Ultrasonic Sensor 1
//#define TRIG_PIN_2 9      // Trigger Pin of Ultrasonic Sensor 2
//#define ECHO_PIN_2 8      // Echo Pin of Ultrasonic Sensor 2
#define SERVOMD_PIN 12    // Servo Pin
